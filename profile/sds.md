...
![### 4.5 피싱 의심 문서 탐지](image/4.5_sequence_diagram.png)

**관련 Use Case**: Use Case #8 - 피싱 의심 문서 탐지
...
![### 4.6 피싱 의심 URL 탐지 (문자)](image/4.6_sequence_diagram.png)

**관련 Use Case**: Use Case #9 - 피싱 의심 URL 탐지 (문자)
